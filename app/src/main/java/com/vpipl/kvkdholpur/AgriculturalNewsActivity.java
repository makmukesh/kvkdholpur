 ...
 */
public class AgriculturalNewsActivity extends Activity {

    private String TAG = "AgriculturalNewsActivity";
    ...
    public void SetupToolbar() {
        ...
        heading.setText("Agricultural News");
        img_nav_back = findViewById(R.id.img_nav_back);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            act = AgriculturalNewsActivity.this;
        ...
        /*  GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(AgriculturalNewsActivity.this);
        }
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelectAgricaltureNews, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
