 ...
 */
public class MonthlyAgriculturalWorkActivity extends Activity {

    private String TAG = "MonthlyAgriculturalWorkActivity";
    ...
    public void SetupToolbar() {
        ...
        heading.setText("Monthly Agricultural Work");
        img_nav_back = findViewById(R.id.img_nav_back);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            act = MonthlyAgriculturalWorkActivity.this;
        ...
        /*  GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(MonthlyAgriculturalWorkActivity.this);
        }
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelectMonthlyAgricaltureWork, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
