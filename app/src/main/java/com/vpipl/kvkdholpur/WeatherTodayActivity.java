 ...
 */
public class WeatherTodayActivity extends Activity {

    private String TAG = "WeatherTodayActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*  GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(WeatherTodayActivity.this);
        }
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelectTodayWeather, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
