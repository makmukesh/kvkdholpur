...
import com.vpipl.kvkdholpur.Adapter.StoryOfTheFarmer_Adapter;
...
/**
 * Created by Mukesh on 08/01/2021.
 */
public class StoryOfTheFarmerActivity extends Activity {

    private String TAG = "StoryOfTheFarmerActivity";

    Activity act;
    public StoryOfTheFarmer_Adapter adapter;
    ...
    public void SetupToolbar() {
        ...
        heading.setText("Story of the farmer");
        img_nav_back = findViewById(R.id.img_nav_back);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            act = StoryOfTheFarmerActivity.this;
        ...
        /*  GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(StoryOfTheFarmerActivity.this);
        }
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelect_StoryofFormer, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
    ...
    private void getAllActivityListResult(JSONArray jsonArray) {
        try {
            ...
            hashMap1.put("id", "45254");
            hashMap1.put("Name", "Name");
            hashMap1.put("Type", "V");
            hashMap1.put("Photo_Url", "https://www.youtube.com/watch?v=3olM-9vcd4M");
            AppController.PhotoList.add(hashMap1);*/
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                hashMap.put("id", jsonObject.getString("AID"));
                hashMap.put("Name", jsonObject.getString("Name"));
                hashMap.put("Type", jsonObject.getString("Type"));
                if (jsonObject.getString("Type").equalsIgnoreCase("I")) {
                    hashMap.put("Photo_Url", AppUtils.imageURL() + jsonObject.getString("Image"));
                } else {
                    hashMap.put("Photo_Url", jsonObject.getString("VideoUrl"));
                }
    ...
    private void showListView() {
        try {
            if (AppController.PhotoList.size() > 0) {
                adapter = new StoryOfTheFarmer_Adapter(act, AppController.PhotoList);
