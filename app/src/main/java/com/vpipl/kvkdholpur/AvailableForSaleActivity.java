 ...
 */
public class AvailableForSaleActivity extends Activity {

    private String TAG = "AvailableForSaleActivity";
    ...
    public void SetupToolbar() {
        ...
        heading.setText("Available For Sale");
        img_nav_back = findViewById(R.id.img_nav_back);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            act = AvailableForSaleActivity.this;
        ...
        /*  GridLayoutManager gridLayoutManager = new GridLayoutManager(getApplicationContext(),3);
            ...
            e.printStackTrace();
            AppUtils.showExceptionDialog(AvailableForSaleActivity.this);
        }
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected String doInBackground(Void... params) {
                        ...
                        try {
                            ...
                            response = AppUtils.callWebServiceWithMultiParam(act, postParameters, QueryUtils.methodToSelect_AvailableForSale, TAG);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return response;
