...
public class Tranining_List_Adapter extends RecyclerView.Adapter<Tranining_List_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_list;
    LayoutInflater inflater = null;
    Context context;
    String str_filename;

    public Tranining_List_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(inflater.inflate(R.layout.tranninglist_adapter, parent, false));
    }
