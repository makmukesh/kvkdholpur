...
public class Ikaai_List_Adapter extends RecyclerView.Adapter<Ikaai_List_Adapter.MyViewHolder> {
    public ArrayList<HashMap<String, String>> array_list;
    LayoutInflater inflater = null;
    Context context;
    String str_filename;

    public Ikaai_List_Adapter(Context con, ArrayList<HashMap<String, String>> list) {
        array_list = list;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(inflater.inflate(R.layout.ikailist_adapter, parent, false));
    }

    @Override
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            holder.ll_image_ts.setVisibility(View.VISIBLE);
            ...
            if(!array_list.get(position).get("FileURL").equalsIgnoreCase("")){
                ...
                public void onClick(View v) {
                  //  str_filename = "http://versatileitsolution.com/appupload/Package1%20Kharif%20krishi%20karyamala.pdf";
                   ...
                   // String message = "Package1%20Kharif%20krishi%20karyamala.pdf";
                    ...
                    message = Environment.getExternalStorageDirectory() + File.separator + "KVKAlw/" + message;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txt_name;
        ImageView iv_photo;
        LinearLayout ll_download , ll_view ,ll_image_ts;
        ...
        public MyViewHolder(View view) {
            ...
            ll_image_ts = (LinearLayout) view.findViewById(R.id.ll_image_ts);
        }
    }
    ...
    public class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                folder = Environment.getExternalStorageDirectory() + File.separator + "KVKAlw/";

                str_filename = "KVKAlw/" + fileName;
